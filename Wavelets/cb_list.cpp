...
intMatrix bsize_list(int band){
    const intMatrix bsize_list_0{{1,1},{2,1},{1,2},{2,2},{2,4},{4,2},{4,4}, {2,8}, {8,2}, {8,4}, {8, 8}};
    const intMatrix bsize_list_1{{1,2},{1,4},{2,4},{2,8},{4,8}, {8,8}};
    const intMatrix bsize_list_2{{1,2},{2,2},{2,4},{4,4}, {8,8}};
    const intMatrix bsize_list_3{{2,1},{4,1},{4,2},{8,2},{8,4}, {8,8}};
    const intMatrix bsize_list_4{{1,2},{1,4},{2,4},{2,8},{4,8}};
    const intMatrix bsize_list_5{{1,2},{2,2},{4,4},{4, 8}, {8,8}};
    const intMatrix bsize_list_6{{2,1},{4,1},{4,2},{8,2},{8,4}, {8,8}};
    const intMatrix bsize_list_7{{1,2},{1,4},{2,4},{2,8},{4,8}, {8,8}};
    const intMatrix bsize_list_8{{1,2},{2,2},{4,4},{4, 8}, {8,8}};
    const intMatrix bsize_list_9{{2,1},{4,1},{4,2},{8,2},{8,4},{8,8}};
...
vector<int> csize_list(int band){
    const vector<int> csize_list_0{32, 64, 128, 256, 512, 1024};
    const vector<int> csize_list_1{8,16, 32, 64, 128, 256, 512, 1024, 2048};
    const vector<int> csize_list_2{8,16, 32,  64, 128, 256, 512, 1024, 2048};
    const vector<int> csize_list_3{8,16, 32,64, 128, 256, 512, 1024, 2048};
    const vector<int> csize_list_4{8,16, 32,64, 128, 256, 512, 1024, 2048};
    const vector<int> csize_list_5{8,16, 32,64, 128, 256, 512, 1024, 2048};
    const vector<int> csize_list_6{8,16, 32,64, 128, 256, 512, 1024, 2048};
    const vector<int> csize_list_7{8,16, 32,64, 128, 256, 512, 1024};
    const vector<int> csize_list_8{8,16, 32,64, 128, 256, 512, 1024};
    const vector<int> csize_list_9{8,16, 32,64, 128, 256, 512, 1024};
