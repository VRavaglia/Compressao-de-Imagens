...
struct cum_freqs * findInTable(struct freqs *freq, struct cum_freqs *cum_freq, struct cum_freqs *cum_freq_1, const int *context, int cSize, int symbol, bool *foundInTable);
